...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '欢迎来到SWONG空间,您即将进入四次元时代',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SWONG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个有故事的手链品牌', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-blue-one.vercel.app/archive', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '手链, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'SWONG@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'SWONG中国', // 你的微博个人主页
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'SWONG', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/635240f1000000001901c8df?xhsshare=CopyLink&appuid=635240f1000000001901c8df&apptime=1725466390&share_id=c45f3985d6e64e758bd0fad10931a70f', // 小红书主页
